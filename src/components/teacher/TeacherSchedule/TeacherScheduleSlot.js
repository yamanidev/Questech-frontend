...
function TeacherScheduleSlot(props) {
	const { session } = props;
	...
	return (
		<div
			...
			<h2 className="text-lg">{session.sessionId.groupId.promo}</h2>
			<h2 className="text-lg">Group {session.sessionId.groupId.id}</h2>
...
export default TeacherScheduleSlot;
