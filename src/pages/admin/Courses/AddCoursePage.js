...
function AddCoursePage() {
  ...
  function validateFields() {
    if (!codeName || !fullTitle || !level || !semester || !coefficient || !credits) return false;
  ...
  return (
    <div className="container">
      <h1 className="mb-10 text-6xl text-center xl:text-left font-semibold">Add New Course</h1>
      <div className="flex flex-col xl:flex-row items-center xl:justify-between gap-20 xl:gap-0">
        <div className="pl-10 pt-10 flex flex-col gap-3">
          ...
          <Stack spacing={2} direction="row" marginTop={5}>
            <Button variant="contained" color="error" component={Link} to="/admin/courses">
              Cancel
            </Button>
            <Button
              variant="contained"
