...
function EditStudentPage() {
  ...
  const getCurrentStudent = () => {
    adminServices.getStudent(studentId).then((response) => {
  ...
  return (
    <div className="container relative">
      {loading ? (
        ...
        <>
          <h1 className="mb-10 text-6xl text-center xl:text-left font-semibold">Edit Student</h1>
